...
```
    ...
    <ipython-input-3-b8a3ff68a89f> in <module>
          1 # Create second spark context
...
# Code here 
print(sc.defaultParallelism, 'cores')
...
```
    ...
    [('spark.app.id', 'local-1576455677989'),
     ('spark.rdd.compress', 'True'),
     ('spark.serializer.objectStreamReset', '100'),
     ('spark.master', 'local[*]'),
     ('spark.executor.id', 'driver'),
     ('spark.submit.deployMode', 'client'),
     ('spark.driver.port', '41243'),
     ('spark.driver.host', '9d1c4d6de3ad'),
     ('spark.ui.showConsoleProgress', 'true'),
     ('spark.app.name', 'pyspark-shell')]
